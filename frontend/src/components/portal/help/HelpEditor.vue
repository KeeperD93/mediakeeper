<template>
  <div class="pt-help-editor">
    <div class="pt-help-editor-toolbar" v-if="editor">
      <!-- Headings -->
      <button type="button" class="pt-help-tb-btn"
      ...
      <div class="pt-help-tb-pop">
        ...
        <div class="pt-help-tb-palette">
          <button v-for="c in HIGHLIGHT_COLORS" :key="c"
                  class="pt-help-tb-swatch" :style="{ background: c }"
                  type="button" @click="editor.chain().focus().toggleHighlight({ color: c }).run()" />
          <button class="pt-help-tb-swatch pt-help-tb-swatch--clear" type="button"
                  @click="editor.chain().focus().unsetHighlight().run()">×</button>
        </div>
      </div>
      ...
      <div class="pt-help-tb-pop">
        ...
        <div class="pt-help-tb-palette">
          <button v-for="c in TEXT_COLORS" :key="c"
                  class="pt-help-tb-swatch" :style="{ background: c }"
                  type="button" @click="editor.chain().focus().setColor(c).run()" />
          <button class="pt-help-tb-swatch pt-help-tb-swatch--clear" type="button"
      ...
      <!-- Font size -->
      <select class="pt-help-tb-select"
...
import {
  ...
  Highlighter, Palette, List, ListOrdered, Heading2, Heading3,
  AlignLeft, AlignCenter, AlignRight,
  Link as LinkIcon, Quote, Table as TableIcon,
