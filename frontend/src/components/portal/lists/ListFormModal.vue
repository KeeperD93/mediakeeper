...
const title = computed(() =>
  props.mode === 'edit' ? t('portal.lists.form.edit') : t('portal.lists.form.create'),
)
...
@media (hover: hover) {
  .lfm-pill:hover:not(.lfm-pill--active) {
...
@media (hover: hover) {
  .lfm-btn--primary:hover:not(:disabled) {
...
.lfm-fade-enter-from .lfm-panel {
  transform: translateY(12px) scale(0.97);
}
.lfm-fade-leave-to .lfm-panel {
