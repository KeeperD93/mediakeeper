      ...
      <div class="chart-toggles">
        ...
        <div class="toggle-group">
          <button
            ...
            @click="((chartMetric = 'count'), renderChart())"
          >
            {{ $t('stats.playsMetric') }}
          </button>
          <button
            ...
            @click="((chartMetric = 'duration'), renderChart())"
          >
  ...
  const ds = d.groups.map((g, i) => {
    ...
    return {
      ...
      data: d.days.map(day => {
        ...
        return chartMetric.value === 'count'
          ? gd.count || 0
    ...
    options: {
      ...
      scales: {
        ...
        y: {
          ...
          title: {
            display: true,
            text: chartMetric.value === 'count' ? t('stats.playsMetric') : t('stats.minutesLabel'),
            color: mc,
          },
        },
      },
