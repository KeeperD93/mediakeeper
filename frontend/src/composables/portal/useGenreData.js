...
export const GENRE_I18N = {
  28: 'action', 35: 'comedie', 18: 'drame', 53: 'thriller',
  12: 'aventure', 27: 'horreur', 878: 'scienceFiction',
  16: 'animation', 14: 'fantastique', 10751: 'familial',
  99: 'documentaire', 9648: 'mystere', 80: 'crime',
  10749: 'romance', 10759: 'action', 10765: 'scienceFiction',
  36: 'histoire', 37: 'western', 10752: 'guerre', 10402: 'musique',
  10770: 'telefilm', 10762: 'enfants', 10763: 'info',
  10764: 'realite', 10766: 'feuilleton', 10767: 'talkShow',
  10768: 'guerrePolitique',
}
export const GENRE_SLUG = {
  28: 'action', 35: 'comedie', 18: 'drame', 53: 'thriller',
  12: 'aventure', 27: 'horreur', 878: 'science-fiction',
  16: 'animation', 14: 'fantastique', 10751: 'familial',
  99: 'documentaire', 9648: 'mystere',
  10759: 'action', 10765: 'science-fiction',
  36: 'histoire', 37: 'western', 10752: 'guerre',
  10402: 'musique',
}
export const GENRE_EMOJI = {
  28: '💥', 35: '😂', 18: '🎭', 53: '😰', 12: '⚔️', 27: '😱',
  878: '🚀', 16: '✏️', 14: '🧙', 10751: '👨‍👩‍👧', 99: '🎥',
  9648: '🔍', 80: '🔫', 10749: '❤️', 10759: '💥', 10765: '🚀',
  36: '🏛️', 37: '🤠', 10752: '⚔️', 10402: '🎵', 10770: '📺',
  10762: '🧸', 10763: '📰', 10764: '🎬', 10766: '💔',
  10767: '🎙️', 10768: '🪖',
}
...
export const GENRE_COLOR = {
  28: '#ef4444', 35: '#fbbf24', 18: '#3b82f6', 53: '#64748b',
  12: '#f97316', 27: '#991b1b', 878: '#38bdf8', 16: '#a78bfa',
  14: '#8b5cf6', 10751: '#22c55e', 99: '#22c55e', 9648: '#6366f1',
  80: '#dc2626', 10749: '#ec4899', 10759: '#ef4444', 10765: '#38bdf8',
  36: '#b45309', 37: '#a16207', 10752: '#7c2d12', 10402: '#c084fc',
  10770: '#94a3b8', 10762: '#fbbf24', 10763: '#0ea5e9',
  10764: '#14b8a6', 10766: '#f472b6', 10767: '#60a5fa',
  10768: '#64748b',
}
...
export function useGenreData(recoItems, genreIds, excludedItems) {
  ...
  const movieItems = computed(() =>
    (recoItems.value || []).filter(isMovie).slice(0, 20),
  )
  const tvItems = computed(() =>
    (recoItems.value || []).filter(isTv).slice(0, 20),
  )
